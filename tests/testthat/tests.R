...
# library(restriktor)
# 
# object <- benchmarks::My_goric_obj
# # convergent_crit only if the weights are bootstrapped
# out <- restriktor:::goric_benchmark_anova(My_goric_obj, pop_es = 0, 
#                                           ncpus = 1, iter = 5,
#                                           control = list(convergence_crit = 1e-02),
#                                           algorithm = "gibbs",
#                                           mix_weights = "boot"
# )
# 
